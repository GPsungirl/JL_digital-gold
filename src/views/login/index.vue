    ...
    async handleLogin() {
      ...
      if(this.m_valid_addForm('loginForm')){
        ...
        if(res.data.code == '0000'){
          ...
          // 存pp_platformid(用于初始化基础设置)
          
          this.$store.commit('user/SET_PLATFORMID', res.data.data.user.platformid)
          localStorage.setItem('pp_platformid',res.data.data.user.platformid)
          console.log(localStorage.getItem('pp_platformid'))
